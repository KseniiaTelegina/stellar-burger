...
jest.mock('@api', () => ({
  ...
  describe('ordersSlice', () => {
    ...
    describe('reducer', () => {
      ...
      it('обработка getOrders.rejected', () => {
    ...
    describe('async thunk', () => {
      ...
      it('успешное выполнение getOrders', async () => {
      ...
      it('Ошибка в выполнении getOrders', async () => {
